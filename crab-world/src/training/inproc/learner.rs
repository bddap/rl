...
mod tests {
    ...
    fn merge_rollouts_attributes_refusals_and_glitches() {
            ...
            RollOutcome::Rolled {
                output: Box::new(HorizonOutput {
                    ...
                    telemetry: StepTelemetry {
                        ...
                        hard_ccd_link_clamp_candidates: 11,
                        hard_ccd_link_clamp_candidates_max: 8,
                    },
                }),
                ticks: 64,
            },
        ...
        assert_eq!(merged.telemetry.hard_ccd_link_clamp_candidates, 11);
        assert_eq!(merged.telemetry.hard_ccd_link_clamp_candidates_max, 8);
