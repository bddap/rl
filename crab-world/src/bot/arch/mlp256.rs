...
//!
//! Culled at the #200 5b A/B (warm-lineage evidence), restored for bddap/rl#351: the
//! E-vs-F single-flip on the Jun-era tree convicted `mlp512x3` for COLD-start learning
//! (reach plateau ~0.3 vs mlp256's 0.85), so cold runs need this leaf selectable again.
//! Same shape as the culled original — era checkpoints load unchanged.
