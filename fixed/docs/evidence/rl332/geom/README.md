...
Owner: "Launches I saw tended to be near perpendicular to the
...
commit (78d1a2f, the physics regime the sighting on; solver
...
The pre-fix (sighting-regime) soaks luge continuously — seed s2 fires an event
