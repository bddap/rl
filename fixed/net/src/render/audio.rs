...
/// without restructuring the bus (spec, rl#359).
...
/// of the mix (acceptance call, rl#357); body and whistle both ride the
...
pub(super) fn profile(kind: Option<VehicleKind>, speed_mps: f32) -> [f32; 5] {
 ...
 // near-silent, a fall or a claw launch is what roars (spec: "hear wind
