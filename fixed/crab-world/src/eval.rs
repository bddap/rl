...
/// size (directive: average progress over many headings over many deterministically
...
impl PairSweep {
 ...
 /// (directive). Every scored ray is geometrically progressable BY CONSTRUCTION
...
mod tests {
 ...
 /// The mean-pair fold (directive): headline = flat mean over pairs; the min
 ...
 /// progressable for its own heading (directive: many headings × many
