...
//! the GCR lockstep state hash ([`crate::net::sim::Sim::state_hash`]), the crab physics
//! digest ([`crate::bot::physics_digest`]), the policy-weights digest
//! ([`crate::play::policy`]), and the membership roster token ([`crate::net::membership`]).
...
impl Fnv {
    ...
    /// is the agreement-token construction in [`crate::net::membership`].
